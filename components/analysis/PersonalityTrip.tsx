    ...
    >
      ...
      <div className="fixed top-6 left-6 z-50">
        <Link href="/">
          <Button
            size="lg"
            className={`font-mono font-bold backdrop-blur-lg transition-all shadow-lg ${
              raveMode 
                ? 'bg-purple-500/20 border border-purple-500/50 text-purple-300 hover:bg-purple-500/30 hover:border-purple-400'
                : 'bg-gray-900/80 dark:bg-gray-500/20 border border-gray-700 dark:border-gray-500/50 text-gray-100 dark:text-gray-300 hover:bg-gray-800/90 dark:hover:bg-gray-500/30'
            }`}
          >
